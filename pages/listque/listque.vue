<template>
	<view>
		...
		<uni-list v-for="(item, index) in que_list" :key="index" class="list">
		    ...
		    <view>{{item[2]}}</view>
			<view :class="item[7] === 0? 'right' : null">A:&nbsp&nbsp{{item[3]}}</view>
			<view :class="item[7] === 1? 'right' : null">B:&nbsp&nbsp{{item[4]}}</view>
			<view :class="item[7] === 2? 'right' : null">C:&nbsp&nbsp{{item[5]}}</view>
			<view :class="item[7] === 3? 'right' : null">D:&nbsp&nbsp{{item[6]}}</view>
		</uni-list>  

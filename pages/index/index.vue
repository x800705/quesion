<template>
	...
	<text style="display: inline-block;">
		<button style="margin-left:0;width: 200px;display: inline-block;" @click="pre()">上一题</button>
		<button style="margin-right:0;width: 200px;display: inline-block;" @click="next()">下一题</button>
	</text>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			await api.get("getque?list_id=" + this.qid).then(res=>{
				...
				await new Promise((resolve, reject) => {
					uni.request({ 
						...
						success: (res) => {
							...
							res = res.data[0]
							this.q = res[2]
							this.chooseList = res.slice(3,7)
							
							console.log(res.slice(3,7))
